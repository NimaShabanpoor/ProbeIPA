...
export default async function AdminStudentsPage() {
  ...
  const classes = getClasses().map((c) => ({ id: c.id, name: c.name }));
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-8">
        <section className="rounded-xl border border-zinc-700 bg-zinc-900 p-6">
          <h2 className="mb-4 text-lg font-semibold text-zinc-100">Neuen Schüler anlegen</h2>
        ...
        <section className="overflow-hidden rounded-xl border border-zinc-700 bg-zinc-900">
          <div className="border-b border-zinc-700 px-6 py-4">
            <h2 className="text-lg font-semibold text-zinc-100">Alle Schüler</h2>
          </div>
